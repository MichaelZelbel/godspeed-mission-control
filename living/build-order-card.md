...
- [ ] 3. Install the app and sign in, run Mission Control installer, drag your
      file in, point the app at `godspeed`, first job (Ch 3). **You have:**
...
- [ ] 5. Only if you write code: open Mission Control in your editor, make the
