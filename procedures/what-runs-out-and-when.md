...
*Bookmark the prompt, if you like: [querino.ai/prompts/add-a-deadline-to-my-godspeed](https://querino.ai/prompts/add-a-deadline-to-my-hub)*
...
notes like `godspeed: from 1 Feb`, and your assistant picks it up on the next morning
run.
