...
# The same primitives Mission Control installer uses, fetched from an immutable
...
[ -d "$GODSPEED" ] || die "No folder at $GODSPEED. That folder is your assistant's memory,
   the one Chapter 28 put on this machine. Set GODSPEED=/path/to/it and run this again."
...
# Mission Control is reached through terminal.cwd, set above, never through the unit.
