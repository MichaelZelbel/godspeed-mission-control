...
# already holds your folder, and for a fresh mission control what its new private repository
...
WHY
  ...
  # in the assistant's home rather than Mission Control. So the folder's path is written
