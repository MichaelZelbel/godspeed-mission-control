...
*[Copy prompt](https://srv1328602.hstgr.cloud/godspeed/8d0da988c1c44fbaa71bdfef1d4144dc/prompts.html#chapter-13-box-1)*
...
Keep prompts meant for separate image or video tools in `prompts/library/`. Name them for the job, such as `draw-cover-art-my-way.md`. Mission Control's starter rules treat that folder as reference material to search when asked.
