...
your mission control about something with a deadline (Chapter 33). If you never do, you have an empty folder
...
If you have `secrets/expires.txt` from Chapter 27, `mc-due` reads it and treats each key as one of
...
`godspeed: from 1 Feb`. **The calendar never decides when you get nagged and never knows whether you
acted.**
