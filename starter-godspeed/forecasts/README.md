# forecasts - what your mission control expects to happen, written down so it can be wrong
...
question is whether your mission control beat what history alone would have said on the same questions.
...
```
mc-forecast file --question "..." --resolves-when "..." --deadline YYYY-MM-DD
                  (--p 0.xx | --low N --high N --unit U) --reference-class "..." --evidence "..."
mc-forecast revise <id> --p 0.xx --why "..."        appends; never after the deadline
mc-forecast resolve <id> --outcome yes|no|void --evidence "..." [--value N]
