...
The optional copy helper downloads supported records, not every original note or attachment. Inspect a separate export when you need those originals. Only after configuring a Menerio account, use:
