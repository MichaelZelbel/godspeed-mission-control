...
//
// WHERE IS MY GODSPEED? `GODSPEED_ROOT` if it is set, else the first folder at or above the folder you
// are standing in that looks like a mission control (it has a `rules/` or an `observations/` folder), else
// the mission control this machine was joined to, recorded in `~/.godspeed/device.env`. So typing one of these
