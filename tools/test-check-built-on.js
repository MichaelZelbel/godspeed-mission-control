#!/usr/bin/env node
// Smoke test for tools/check-built-on.js: a throwaway mission control root, files written
// by hand, PASS/FAIL per check, non-zero exit on any FAIL. No dependencies.
// The same test runs against Mission Control's own copy in scripts/; the two programs
...
// --- an empty mission control is clean, and says why ------------------------------------
root = freshGodspeed();
r = run(root);
