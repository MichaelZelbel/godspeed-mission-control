/*
 * A stand-in for Gmail's IMAP door, for the hub-mail tests. Loopback only, invented addresses
 ...
 * hub uses (sign in, list folders with their special-use marks, folder status, search, fetch,
 ...
 *
 * Usage (from a test): const f = await require("./test-hub-mail-imap-fixture.js").start();
...
// IMAP SEARCH keys, the ones the hub's calls produce: parentheses, OR, NOT, header and text
